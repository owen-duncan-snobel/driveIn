    ...
    return (
        <Router>
                ...
                <div className="flex items-center justify-between md:justify-start">
                    ...
                    <div className="md:hidden m-6">
                        <button onClick={() => setNavbarOpen(!navbarOpen)}>
                            <svg className="stroke-current text-gray-900 w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            {/* <nav className="flex flex-wrap p-6 justify-between">
                ...
                <div className={"flex-grow items-center " + (navbarOpen ? "flex" : "hidden")} >
                    <div className="md:flex sm:w-auto sm:hidden">
                        <div className="text-sm font-semibold hidden md:block ml-4">
                            <NavLink exact to="/nowplaying" className="block  sm:inline-block lg:mt-0 mr-4 text-gray-500 hover:text-gray-900" activeClassName="text-gray-900" >
                                Now Playing
                                </NavLink>
                            <NavLink exact to="/comingsoon" className="block  sm:inline-block lg:mt-0 mr-4  text-gray-500 hover:text-gray-900" activeClassName="text-gray-900" >
                ...
                <button className="md:hidden text-right" onClick={() => setNavbarOpen(!navbarOpen)}>
